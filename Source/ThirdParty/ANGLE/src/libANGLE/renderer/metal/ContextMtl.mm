...
ContextMtl::ContextMtl(const gl::State &state,
    ...
    : ContextImpl(state, errorSet),
      mtl::Context(display/*, egl::FromEGLenum<egl::ContextPriority>(state.getContextPriority())*/),
      mCmdBuffer(&display->cmdQueue(egl::FromEGLenum<egl::ContextPriority>(state.getContextPriority()))),
